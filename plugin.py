        ...
        try:
            ...
            if (
                ...
                if "value_template" in configdict:
                    m = re.match(
                        r"^\s*{\s*{\s*value_json\.(\w+)\s*}\s*}$", configdict["value_template"]
                    )
                    if m:
            ...
            if "rgb_state_topic" in devicetopics:
                ...
                if "rgb_value_template" in configdict:
                    m = re.match(
                        r"^\s*{\s*{\s*value_json\.(\w+)\s*}\s*}\s*$", configdict["rgb_value_template"]
                    )
                    if m:
        ...
        try:
            ...
            if "availability_topic" in devicetopics:
                ...
                if "availability_template" in configdict:
                    m = re.match(
                        r"^\s*{\s*{\s*value_json\.(\w+)\s*}\s*}\s*$", configdict["availability_template"]
                    )
